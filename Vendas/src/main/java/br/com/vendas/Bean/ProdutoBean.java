...
public class ProdutoBean implements Serializable {
	...
	public void editar(ActionEvent evento){
		try {
			...
			produto.setCaminho("D:/Trabalho/uploads/" + produto.getCodigo() + ".jpg");
	...
	public void salvar() {
		try {
			...
			Path destino = Paths.get("D:/Trabalho/uploads/" + produtoRetorno.getCodigo() + ".jpg");
	...
	public void excluir(ActionEvent evento) {
		try {
			...
			Path arquivo = Paths.get("D:/Trabalho/uploads/" + produto.getCodigo() + ".jpg");
